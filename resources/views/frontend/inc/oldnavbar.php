<div class="header bg-white">
                            ...
                            <ul class="dropdown-menu">
                                @foreach (\App\Language::all() as $key => $language)
                                    <li class="dropdown-item @if($locale == $language) active @endif">
                                        <a href="#" data-flag="{{ $language->code }}"><img src="{{ asset('frontend/images/icons/flags/'.$language->code.'.png') }}" class="flag lazyload" alt="{{ $language->name }}" height="11"><span class="language">{{ $language->name }}</span></a>
                                    </li>
                                @endforeach
                            </ul>
                        </li>
        ...
        <div class="">
            <div class="container">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-lg-6 col-sm-12 position-static">
    ...
    <!-- Navbar -->
	<!-- Top Bar -->
    <div style="padding: 10px;background-color: #e7b6af;">
        <div class="container">
            <div class="row">
            	<div class="col-lg-3 col"></div>
                <div class="col-lg-6 col-sm-12">
                	 <ul class="inline-links d-lg-inline-block d-flex justify-content-between">
                            @foreach (\App\Category::all()->take(7) as $key => $category)
                                @php
                                    $brands = array();
                                @endphp
                                <li class="category-nav-element" data-id="{{ $category->id }}">
