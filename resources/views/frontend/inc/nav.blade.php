        ...
        <div class="header__top">
            ...
            <div class="header__center">
                    <form class="ps-form--quick-search" action="#" method="get">
                        ...
                        <button class="bg-theme-col">Search</button>
                    </form>
                </div>
                ...
                <div class="header__left">
                    ...
                    </div><a class="ps-logo" href="{{ route('home') }}">@php
                ...
                <div class="header__right">
                    <div class="header__actions"><a class="header__extra" href=""  title="compare"><i class="icon-chart-bars"></i>
                    ...
                    <a class="header__extra" href="{{ route('wishlists.index') }}" title="wishlist"><i class="icon-heart"></i>
                    @if(Auth::check())
                    <span><i>{{ count(Auth::user()->wishlists)}}</i></span>
                    @else
                    <span><i>0</i></span>
                    @endif
                    </a>
                        <div class="ps-cart--mini"><a class="header__extra" href="#" ><i class="icon-bag2"></i>
                        @if(Session::has('cart'))
                        <span><i>{{ count(Session::get('cart'))}}</i></span>
                        @else
                        <span><i>0</i></span>
                        @endif </a>
                        ...
                        <div class="ps-block--user-header">
                            ...
                            <div class="ps-block__right"><a href="{{ route('user.login') }}">Login</a><a href="{{ route('user.registration') }}">Register</a></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="navigation__right">
                    ...
                    @foreach (\App\Category::all()->take(11) as $key => $category)
                                @php
                                    $brands = array();
                                @endphp
                        <li class="menu-item-has-children"><a href="{{ route('products.category', $category->slug) }}">
                        {{ __($category->name) }}
                        </a>
                        @if(count($category->subcategories)>0)
                        <span class="sub-toggle"></span>
                            <ul class="sub-menu">
                                <li class="current-menu-item menu-item-has-children"><a href="index.html">Marketplace Full Width</a><span class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                    ...
                    <ul class="navigation__extra">
                        <li><a href="#">Sell on Mode Collection</a></li>
                        ...
                        <li>
                            ...
                            <a>
                                ...
                                @foreach (\App\Currency::where('status', 1)->get() as $key => $currency)
                                    <li class="dropdown @if($currency_code == $currency->code) active @endif">
